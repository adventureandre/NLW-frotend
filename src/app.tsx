  ...
  return (
    <div className="h-screen flex items-center justify-center ">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shado " >
          <div className="flex item-center gap-2 flex-1">
            <MapPin className="size-5 text-zinc-400" />
            <input type="text " placeholder="Para onde voçê vai?" className="bg-transparent text-lg placeholder-zinc-400" />
          </div>
