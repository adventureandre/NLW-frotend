...
export function DestinationAndDateStep({
    ...
    ? format(eventStartAndDates.to,"d 'de ' LLL ").concat(' até ').concat(format(eventStartAndDates.to,"d 'de ' LLL "))
    : null
    ...
    return (
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3 " >
            ...
            <button onClick={openDatePicker} disabled={isGuestsInputOpen} className="flex item-center gap-2 text-left w-[240px]">
            ...
            {isDatePickerOpen && (
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
                    <div className="rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
                        ...
                        <DayPicker mode="range" selected={eventStartAndDates} onSelect={setEventStartAndEndDates} />
                    </div>
                </div>
            )}
